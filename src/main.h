...
extern CMainCriticalSection cs_main;
...
void PartitionCheck(bool (*initialDownloadCheck)(), CMainCriticalSection& cs, const CBlockIndex *const &bestHeader, int64_t nPowTargetSpacing);
