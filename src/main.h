...
extern CWaitableCriticalSection cs_main;
...
void PartitionCheck(bool (*initialDownloadCheck)(), CWaitableCriticalSection& cs, const CBlockIndex *const &bestHeader, int64_t nPowTargetSpacing);
